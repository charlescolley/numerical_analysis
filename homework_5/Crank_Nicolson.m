function [ solution ] = Crank_Nicolson(Input_Function,Input_Derivative,initial_value,h,domain)
%	Charlie Colley
%   Crank Nicolson ode solver
%   12/3/2014
...
for i = 2:length
Function = @(t) solution(i-1)+(h/2)*(Input_Function(solution(i-1))+Input_Function(t)) - t;
Derivative =@(t) (h/2)*Input_Derivative(t) - 1;
